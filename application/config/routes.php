...
$route['rooms/(:any)/members']['get'] = 'rooms_controller/select_users/$1';
$route['rooms/(:any)/members']['post'] = 'rooms_controller/create_user/$1';
$route['rooms/(:any)/members/(:any)']['get'] = 'rooms_controller/select_user/$1/$2';
$route['rooms/(:any)/members/(:any)/messages']['get'] = 'rooms_controller/select_messages/$1/$2';
$route['rooms/(:any)/members/(:any)/messages']['post'] = 'rooms_controller/create_message/$1/$2';
