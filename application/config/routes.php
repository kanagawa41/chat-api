...
$route['rooms/(:any)/messages/all']['get'] = 'rooms_controller/select_messages_all/$1';
$route['rooms/(:any)/messages/ahead/(:num)']['get'] = 'rooms_controller/select_messages_ahead/$1/$2';
