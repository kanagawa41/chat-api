...
$route['404_override'] = 'errors_controller/error_404';
$route['translate_uri_dashes'] = FALSE;
...
$route['rooms/(:any)/members']['put'] = 'rooms_controller/update_user/$1';
...
$route['rooms/members/pastroom/(:num)']['get'] = 'rooms_controller/select_pastroom/$1';
